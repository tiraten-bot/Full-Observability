...
func registerDBPoolMetrics(sqlDB *sql.DB) {
	...
	dbMaxOpenConns := prometheus.NewGaugeFunc(
		prometheus.GaugeOpts{
			Name: "product_service_db_max_open_connections",
	...
	dbOpenConns := prometheus.NewGaugeFunc(
		prometheus.GaugeOpts{
			Name: "product_service_db_open_connections",
	...
	dbInUseConns := prometheus.NewGaugeFunc(
		prometheus.GaugeOpts{
			Name: "product_service_db_in_use_connections",
	...
	dbIdleConns := prometheus.NewGaugeFunc(
		prometheus.GaugeOpts{
			Name: "product_service_db_idle_connections",
	...
	dbWaitCount := prometheus.NewCounterFunc(
		prometheus.CounterOpts{
			Name: "product_service_db_wait_count_total",
	...
	dbWaitDuration := prometheus.NewCounterFunc(
		prometheus.CounterOpts{
			Name: "product_service_db_wait_duration_seconds_total",
	...
	dbMaxIdleClosed := prometheus.NewCounterFunc(
		prometheus.CounterOpts{
			Name: "product_service_db_max_idle_closed_total",
	...
	dbMaxLifetimeClosed := prometheus.NewCounterFunc(
		prometheus.CounterOpts{
			Name: "product_service_db_max_lifetime_closed_total",
